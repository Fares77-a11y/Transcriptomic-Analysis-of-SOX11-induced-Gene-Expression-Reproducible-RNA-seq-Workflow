...
|--------|------|--------------|
| Sample Distance Heatmap | sample_distance_heatmap.JPEG | VST-normalized, shows Euclidean clusters |
| PCA Plot | pca_plot.jpeg | Visualizes main variance between conditions |
| Volcano Plot | Volcano_plot_Log2FC I1I.jpeg | All DEGs (padj<0.05, |log2FC|>1) |
| Labeled Volcano | Volcano_plot_Log2FC I1I_gene_names.jpeg | Key DEGs labeled (padj<0.01, |log2FC|>1) |
| Top 100 DEGs Heatmap | TOP 50 genes heatmap.jpeg | Heatmap, top significant genes |
